...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/pages/demo2.js":[function(require,module,exports) {
  ...
  var Item = /*#__PURE__*/function () {
    function Item(el) {
      ...
      this.renderedStyles = {
        ...
        itemRotation: {
          ...
          //fromValue: -45,
          setValue: function setValue() {
            var fromValue = _this.renderedStyles.itemRotation.fromValue;
            var toValue = 0;
            var val = MathUtils.map(_this.props.top - docScroll, winsize.height, winsize.height / 2 - _this.props.height / 2, fromValue, toValue);
            return fromValue < 0 ? Math.min(Math.max(val, fromValue), toValue) : Math.max(Math.min(val, fromValue), toValue);
          }
        },
        imageScaleX: {
          ...
          setValue: function setValue() {
            var fromValue = 1;
            var toValue = 0.7;
            var val = MathUtils.map(_this.props.top - docScroll, winsize.height / 6, -1 * _this.props.height, fromValue, toValue);
    ...
    _createClass(Item, [{
      ...
      value: function layout() {
        ...
        this.DOM.imageWrapper.style.transform = "scale3d(".concat(this.renderedStyles.imageScaleX.previous, ",").concat(this.renderedStyles.imageScaleY.previous, ",1)");
        // translate the title
        this.DOM.title.style.transform = "translate3d(0,".concat(this.renderedStyles.titleTranslationY.previous, "px,0)");
        // rotate the item
        this.DOM.el.style.transform = "rotate3d(0,0,1,".concat(this.renderedStyles.itemRotation.previous, "deg)");
      }
    }]);
    return Item;
  }(); // SmoothScroll
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/pages/demo2.js"], null)
//# sourceMappingURL=/demo2.e9708aea.js.map