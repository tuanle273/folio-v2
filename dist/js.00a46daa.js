...
var Home = /*#__PURE__*/function () {
  ...
  _createClass(Home, [{
    key: "homeActions",
    value: function homeActions() {
      var _this2 = this;

      (0, _each.default)(toContactButtons, function (button) {
        button.onclick = function () {
          _this2.locomotive.scrollTo(footer);
        };
      });
    ...
    value: function homeAnimations() {
      ...
      _gsap.default.utils.toArray("[data-fade-in]").forEach(function (el) {
        _gsap.default.from(el, {
          scrollTrigger: {
            trigger: el,
            scroller: "[data-scroll-container]"
          },
...
function CurosrEffect() {
  ...
  this.cursorQuickSetter = _gsap.default.quickSetter(this.cursor, "css");
  this.cursorOvalQuickSetter = _gsap.default.quickSetter(this.cursorOval, "css");
  this.renderStyle = {
    current: {
      x: 1,
      y: 1
  ...
  this.__map = function (x, a, b, c, d) {
    return ((x - a) * (d - c) / (b - a) + c).toFixed(3);
  };

  this.__lerp = function (a, b, n) {
    return ((1 - n) * a + n * b).toFixed(3);
  };

  this.render = function () {
    _this3.renderStyle.current.x = _this3.__lerp(_this3.renderStyle.current.x, _this3.renderStyle.last.x, _this3.renderStyle.ease);
    _this3.renderStyle.current.y = _this3.__lerp(_this3.renderStyle.current.y, _this3.renderStyle.last.y, _this3.renderStyle.ease);
    var disMoveX = Math.abs(_this3.renderStyle.last.x) - Math.abs(_this3.renderStyle.current.x);
    var disMoveY = Math.abs(_this3.renderStyle.last.y) - Math.abs(_this3.renderStyle.current.y);
    var disMove = Math.abs(Math.max(Math.abs(disMoveX), Math.abs(disMoveY)));

    var scaleX = _this3.__map(disMove, 0, 160, 1, 1.2);

    var scaleY = _this3.__map(disMove, 0, 160, 1, 0.85);

    _this3.cursorQuickSetter({
      x: _this3.renderStyle.current.x,
      y: _this3.renderStyle.current.y
    });

    var rotation = Math.atan(disMoveY / disMoveX) * 180 / Math.PI;

    if (rotation) {
      _this3.cursorOvalQuickSetter({
        rotation: rotation,
        scaleY: scaleY,
        scaleX: scaleX
      });
...
new CurosrEffect(); // - Noel Delgado | @pixelia_me
...
var Item = /*#__PURE__*/function () {
  function Item(element) {
    ...
    this.element.addEventListener("mouseover", function (ev) {
      return _this4.update(ev, "in");
    });
    this.element.addEventListener("mouseout", function (ev) {
      return _this4.update(ev, "out");
    });
  }
...
var section3 = $("#section3").offset().top; // number of pixels before the section to change image

var scrollOffset = 300; // run this function when the window scrolls

$(window).scroll(function () {
  // get the window height on scroll
  var scroll = $(window).scrollTop() + scrollOffset; // if scroll hits the top of section 1
...
popup.init();
},{"gsap":"../node_modules/gsap/index.js","gsap/ScrollTrigger":"../node_modules/gsap/ScrollTrigger.js","locomotive-scroll":"../node_modules/locomotive-scroll/dist/locomotive-scroll.esm.js","lodash/each":"../node_modules/lodash/each.js","./utils/index":"js/utils/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
